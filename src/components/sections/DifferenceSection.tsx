      ...
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="mt-8 grid gap-8 md:grid-cols-3">
          {featured.map((card, i) => (
            ...
            >
              {card.id === "contracts" ? (
                <Image src="/no-contracts-icon.svg" alt="" width={72} height={72} className="mb-4 max-w-[72px]" aria-hidden />
              ) : card.id === "schedule" ? (
                <Image src="/schedule-icon.svg" alt="" width={72} height={72} className="mb-4 max-w-[72px]" aria-hidden />
              ) : card.id === "nontoxic" ? (
                <Image src="/plant-icon.svg" alt="" width={72} height={72} className="mb-4 max-w-[72px]" aria-hidden />
              ) : (
